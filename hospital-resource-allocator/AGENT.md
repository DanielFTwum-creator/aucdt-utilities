# hospital-resource-allocator - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for hospital-resource-allocator.
...
All notable changes to the Hospital Resource Allocator (App ID 131) project will be documented in this file.
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Hospital Resource Allocator | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Hospital Resource Allocator | Techbridge University College" />
    ...
    <title>Hospital Resource Allocator | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root" role="main" aria-label="Hospital Resource Allocator">
      <div class="tuc-splash">
        <span class="tuc-logo">TECHBRIDGE</span>
        <div class="tuc-status">hospital resource allocator</div>
...
```json
{
  "name": "hospital-resource-allocator",
  "version": "2.0.0",
  "private": true,
...
/**
 * E2E stub — hospital-resource-allocator
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('hospital-resource-allocator E2E', () => {
