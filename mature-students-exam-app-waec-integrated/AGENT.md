# mature-students-exam-app-waec-integrated - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for mature-students-exam-app-waec-integrated.
...
const AUTH_KEY = 'tuc_auth_mature_students_exam_app_waec_integrated';
const ACCENT   = '#0d9488';
    ...
    <div style={{minHeight:'100vh',background:'#f8fafc',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Inter,system-ui,sans-serif'}}>
      <div style={{background:'#fff',padding:'36px',borderRadius:'16px',boxShadow:'0 4px 24px rgba(0,0,0,0.10)',width:'100%',maxWidth:'420px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'6px'}}>
          ...
          <h1 style={{fontSize:'20px',fontWeight:'700',color:'#0f172a',margin:0}}>Mature Students Exam App Waec Integrated</h1>
        </div>
...
export const ExamStartScreen: React.FC<ExamStartScreenProps> = ({ questionCount, onStart, isGeneratingQuestions = false }) => {
  ...
  return (
    <div className="max-w-4xl w-full mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12 text-center border-t-4" style={{ borderColor: COLORS.aucdtGold }}>
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-3" style={{ color: COLORS.aucdtDeepBrown }}>TUC Mature Students Entrance Examination</h1>
        <h2 className="text-xl md:text-2xl mb-8" style={{ color: COLORS.aucdtGreen }}>MSEE 112 Mathematics Aptitude Test</h2>
        ...
        <div className="rounded-lg p-6 mb-8 text-left" style={{ backgroundColor: COLORS.aucdtLightGreen }}>
            ...
            <ul className="space-y-3 text-lg" style={{ color: COLORS.aucdtDarkGray }}>
                <li>• Answer all {questionCount} questions.</li>
...
export const defaultQuestions: Question[] = [
    ...
    { id: 22, question: "A circle has a radius of 7 cm. Calculate the area of the circle. (Take π = 22/7)", options: ["44 cm²", "88 cm²", "154 cm²", "308 cm²", "None of these"], correct: 2 },
    { id: 23, question: "If log₁₀ 2 = 0.301 and log₁₀ 3 = 0.477, find log₁₀ 6.", options: ["0.176", "0.477", "0.699", "0.778", "None of these"], correct: 3 },
    { id: 24, question: "A quadratic function f(x) = x² - 6x + 8 has roots at x = a and x = b. What is the value of a + b?", options: ["2", "4", "6", "8", "None of these"], correct: 2 }
];
```
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Mature Students Exam App Waec Integrated | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Mature Students Exam App Waec Integrated | Techbridge University College" />
    ...
    <title>Mature Students Exam App Waec Integrated | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root">
      <div class="tuc-splash">
        ...
        <div class="tuc-status">mature students exam app waec integrated</div>
...
```json
{
  ...
  "description": "An advanced web application for taking and creating mathematics aptitude tests, featuring LaTeX rendering, dynamic diagrams, and AI-powered question generation. Designed for the AUCDT Mature Students Entrance Examination.",
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-60 bg-[#0f172a] text-white flex flex-col p-6 shrink-0" aria-label="Admin navigation">
        <div className="flex items-center gap-3 mb-10">
          ...
          <span className="font-bold text-sm">Mature Students Exam App Waec Integrated</span>
        </div>
      ...
      <main className="flex-1 p-8 max-w-4xl" role="main">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Mature Students Exam App Waec Integrated — Admin</h1>
...
export type DiagramType = 'right_triangle_abc' | 'angles_on_line' | 'pie_chart_colors';
...
```typescript
const generateWAECSystemInstructions = (subject, specificRequirements = {}) => {
  const baseInstruction = `You are an expert ${subject} exam question generator for WAEC Senior High School examinations. Based on the following set of reference questions, generate NEW questions that are similar in style, difficulty, and topic coverage but with different content, scenarios, and contexts.\n\nCORE REQUIREMENTS:\n1. Generate exactly the same number of questions as provided in the reference set\n2. Maintain the same difficulty level and academic concepts appropriate for SHS level\n3. Use different content, scenarios, contexts, and examples\n4. Keep the same question types and format structure\n5. Each question should have exactly 5 options (A, B, C, D, E)\n6. Use "None of these" or "All of the above" as option E when contextually appropriate\n7. Follow WAEC examination standards and marking schemes\n8. Ensure cultural relevance to West African context where applicable\n\nSUBJECT-SPECIFIC REQUIREMENTS:\n${specificRequirements.content || 'Maintain subject-specific terminology and concepts'}\n\nFORMATTING REQUIREMENTS:\n- ${specificRequirements.formatting || 'Use proper academic formatting for the subject'}\n- Include diagrams, charts, or visual elements where the original questions have them\n- Preserve any bonus sections with completely new content\n- Follow the exact same JSON format structure as provided\n\nQUALITY STANDARDS:\n- Questions must be academically rigorous and age-appropriate\n- Avoid ambiguous wording or trick questions\n- Ensure one clearly correct answer per question\n- Make distractors plausible but clearly incorrect\n- Test understanding, not just memorization\n\nCONTENT GUIDELINES:\n- Use diverse examples that reflect West African contexts\n- Include both theoretical and practical applications\n- Maintain progressive difficulty where present in original set\n- Cover the same topic breadth as the reference questions\n\nOriginal questions for reference:\n\${questionsText}\n\nGenerate new variations following the exact same JSON format and maintaining all structural elements.`;
...
export const generateSubjectInstruction = (subject) => {
  const config = subjectConfigurations[subject.toLowerCase()];
  if (!config) {
