  ...
  return (
    <div style={wrap}>
      <div style={card}>
        ...
        <h1 style={title}>TSAPro</h1>
        <p style={tagline}>Techbridge Salary Assistant Pro</p>
...
const title: React.CSSProperties = { fontSize: 36, fontWeight: 800, color: MAROON, margin: '6px 0 4px', lineHeight: 1.1, letterSpacing: '-0.5px' };
const tagline: React.CSSProperties = { fontSize: 16, color: '#475569', fontWeight: 600, margin: '0 0 14px' };
const subtitle: React.CSSProperties = { fontSize: 15, color: '#64748b', marginBottom: 32 };
