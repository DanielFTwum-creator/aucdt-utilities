# tuc-2026-enrollment-command-centre — Deploy Script
# URL: https://ai-tools.techbridge.edu.gh/tuc-2026-enrollment-command-centre/
# Usage: .\deploy.ps1 -Build

param(
    [string]$RemoteHost = "root@techbridge.edu.gh",
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/tuc-2026-enrollment-command-centre/",
    [switch]$Build = $false
)
...
$SUBFOLDER     = "tuc-2026-enrollment-command-centre"
...
Log "INFO" "========================================" Cyan
Log "INFO" "tuc-2026-enrollment-command-centre DEPLOYMENT" Cyan
Log "INFO" "========================================" Cyan
...
if ($Build) {
    ...
    $buildDir = "/tmp/tuc-enroll_deploy_$commit"
    $serverScript = @"
set -e
...
log '[2/5] Cloning tuc-2026-enrollment-command-centre (sparse, depth 1)...'
git clone --depth 1 --filter=blob:none --sparse '$GITHUB_REPO' $buildDir
cd $buildDir
git sparse-checkout set tuc-2026-enrollment-command-centre
cd tuc-2026-enrollment-command-centre
...
<IfModule mod_rewrite.c>
  RewriteEngine On
  RewriteBase /tuc-2026-enrollment-command-centre/
  RewriteCond %{REQUEST_FILENAME} -f [OR]
  RewriteCond %{REQUEST_FILENAME} -d
  RewriteRule ^ - [L]
  RewriteRule ^ /tuc-2026-enrollment-command-centre/index.html [QSA,L]
</IfModule>
...
Log "SUCCESS" "URL  : https://ai-tools.techbridge.edu.gh/tuc-2026-enrollment-command-centre/" Green
