...
Get-ChildItem -Path "dist" | ForEach-Object {
    if (# TUC 2026 Enrollment Command Centre Deployment Script
# SCP-based deployment using bash
...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/enrollment-2026`n"
# TUC 2026 Enrollment Command Centre Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/enrollment-2026`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# TUC 2026 Enrollment Command Centre Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/enrollment-2026`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# TUC 2026 Enrollment Command Centre Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/enrollment-2026`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
