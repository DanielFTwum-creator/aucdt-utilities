// cypress/e2e/screenshot-all-apps.cy.ts
...
const APPS = [
  ...
  { slug: "lems", name: "Lecturer Evaluation & Management System (LEMS)" },
  ...
  { slug: "playgrow", name: "PlayGrow" },
  { slug: "smartscale-ai-presentation-platform", name: "SmartScale Presentations" },
  { slug: "youtube-genie", name: "YouTube Genie Music" },
  // Additional creative tools would go here

  // Dev Tools (11)
  { slug: "ai-techbridge", name: "AI Stack Debugger" },
  { slug: "code-assistant", name: "Code Assistant" },
  // Additional dev tools would go here

  // Business (16)
  { slug: "expensepro", name: "ExpensePro" },
  { slug: "impact-ventures-dashboard", name: "Impact Ventures Dashboard" },
  { slug: "rophe-care-rpms", name: "Rophe Care RPMS" },
  { slug: "techbridge-ai-application-portal", name: "TechBridge AI Application Portal" },
  // Additional business tools would go here

  // Health & Wellness
  { slug: "glucose", name: "Glucose (GlucoSentinel)" },
  { slug: "rophe-sugar-logger", name: "Rophe Sugar Logger" },
  { slug: "orbit-walk-reminder", name: "Orbit Walk Reminder" },

  // Admin (13)
  { slug: "ai-studio-project-refresh", name: "AI Studio Project Refresh" },
  { slug: "ai-transformation-framework", name: "AI Transformation Framework" },
  // Additional admin tools

  // Games (4)
  { slug: "brainiac-challenge", name: "Brainiac Challenge" },
  // Additional games
];
...
describe("TUC AI Lab - App Screenshot Suite", () => {
  ...
  APPS.forEach((app, index) => {
    it(`[${index + 1}/${APPS.length}] ${app.name} - Screenshot`, () => {
      ...
      // Check if page has loaded (not 404)
