      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
        <div className="md:col-span-2">
          ...
          <div className="flex space-x-6">
            <a href="#" className="label-caps hover:text-tuc-gold transition-colors">Instagram</a>
            <a href="#" className="label-caps hover:text-tuc-gold transition-colors">Facebook</a>
            <a href="#" className="label-caps hover:text-tuc-gold transition-colors">Pinterest</a>
          </div>
        </div>
