    ...
    <div className="min-h-screen bg-gradient-to-br from-academic-navy to-academic-blue">
      ...
      <header className="bg-white/10 backdrop-blur-sm border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex gap-6">
            ...
            <Link
              to="/login"
              className="bg-academic-amber hover:bg-academic-gold text-academic-navy px-4 py-2 rounded-lg font-medium transition-colors"
            >
              Get Started
            </Link>
          </nav>
      ...
      <main className="max-w-7xl mx-auto px-4 py-20">
        ...
        >
          ...
          <Link
            to="/register"
            className="inline-block bg-academic-gold hover:bg-academic-amber text-academic-navy px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:scale-105 shadow-lg"
          >
            Start Assessment
          </Link>
        </motion.div>
