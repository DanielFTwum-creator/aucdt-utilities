...
export const Header: React.FC<HeaderProps> = ({ module, onHomeClick }) => {
  return (
    <header className="h-20 flex-shrink-0 flex items-center justify-between px-6 lg:px-8 border-b border-[var(--color-border-card)]/50 bg-[var(--color-background-main)]">
      <div className="flex items-center space-x-4">
        ...
        {module ? (
          ...
          <div>
            ...
            <p className="text-sm text-[var(--color-foreground-muted)] font-inter">Welcome to the dmcdAI Learning Sandbox</p>
          </div>
        )}
      </div>
      <div className="flex items-center space-x-4">
