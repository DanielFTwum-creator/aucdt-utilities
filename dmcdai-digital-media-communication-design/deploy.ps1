...
Log "INFO" "=== DMCDAI DEPLOYMENT ===" Cyan
...
Log "INFO" "Copying files..." Yellow
bash -c "cd 'C:\Development\github\aucdt-utilities\dmcdai-digital-media-communication-design' && scp -r -o StrictHostKeyChecking=no dist/* $RemoteHost`:$RemotePath 2>/dev/null"
...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/dmcdai`n"
# dmcdAI Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/dmcdai`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# dmcdAI Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/dmcdai`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# dmcdAI Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/dmcdai`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
