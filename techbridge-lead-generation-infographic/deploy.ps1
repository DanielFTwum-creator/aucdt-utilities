# techbridge-lead-generation-infographic — Deploy Script
# URL: https://ai-tools.techbridge.edu.gh/techbridge-lead-generation-infographic/
# Usage: .\deploy.ps1 -Build

param(
    [string]$RemoteHost = "root@techbridge.edu.gh",
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/techbridge-lead-generation-infographic/",
    [switch]$Build = $false
)
...
$SUBFOLDER     = "techbridge-lead-generation-infographic"
...
Log "INFO" "========================================" Cyan
Log "INFO" "techbridge-lead-generation-infographic DEPLOYMENT" Cyan
Log "INFO" "========================================" Cyan
...
if ($Build) {
    ...
    $buildDir = "/tmp/tb-lead-gen_deploy_$commit"
    $serverScript = @"
set -e
...
log '[2/5] Cloning techbridge-lead-generation-infographic (sparse, depth 1)...'
git clone --depth 1 --filter=blob:none --sparse '$GITHUB_REPO' $buildDir
cd $buildDir
git sparse-checkout set techbridge-lead-generation-infographic
...
<IfModule mod_rewrite.c>
  RewriteEngine On
  RewriteBase /techbridge-lead-generation-infographic/
  RewriteCond %{REQUEST_FILENAME} -f [OR]
  RewriteCond %{REQUEST_FILENAME} -d
  RewriteRule ^ - [L]
  RewriteRule ^ /techbridge-lead-generation-infographic/index.html [QSA,L]
</IfModule>
...
Log "SUCCESS" "URL  : https://ai-tools.techbridge.edu.gh/techbridge-lead-generation-infographic/" Green
