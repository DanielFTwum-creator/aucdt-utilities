# typing-and-mathematics-tutorial — Deploy Script
# URL: https://ai-tools.techbridge.edu.gh/math-island/
# Usage: .\deploy.ps1 -Build

param(
    [string]$RemoteHost = "root@techbridge.edu.gh",
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/math-island/",
    [switch]$Build = $false
)
...
$SUBFOLDER     = "typing-and-mathematics-tutorial"
...
Log "INFO" "========================================" Cyan
Log "INFO" "typing-and-mathematics-tutorial DEPLOYMENT" Cyan
Log "INFO" "========================================" Cyan
...
if ($Build) {
    ...
    $buildDir = "/tmp/math-island_deploy_$commit"
    $serverScript = @"
set -e
...
log '[2/5] Cloning typing-and-mathematics-tutorial (sparse, depth 1)...'
git clone --depth 1 --filter=blob:none --sparse '$GITHUB_REPO' $buildDir
cd $buildDir
git sparse-checkout set typing-and-mathematics-tutorial
...
Log "SUCCESS" "URL  : https://ai-tools.techbridge.edu.gh/math-island/" Green
