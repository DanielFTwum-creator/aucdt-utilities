    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8 space-y-8">
          {/* Overview */}
          <section>
            <h2 className="text-xl font-bold text-[#1F3864] dark:text-blue-300 mb-3">What is a Reading?</h2>
            <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-[#2E75B6] p-4 rounded">
              ...
              <div className="grid grid-cols-2 gap-2 mt-3 text-sm dark:text-slate-300">
          ...
          {/* How to Add Readings */}
          <section>
            <h2 className="text-xl font-bold text-[#1F3864] dark:text-blue-300 mb-4">How to Add Readings</h2>
            ...
            <div className="mb-6 border-l-4 border-orange-400 pl-4">
              ...
              <div className="bg-orange-50 dark:bg-orange-900/20 dark:text-orange-100 p-4 rounded space-y-2 text-sm">
            ...
            <div className="border-l-4 border-amber-400 pl-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h3 className="font-semibold text-slate-900 dark:text-white">Scan Photo</h3>
              </div>
              <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">
                Upload a photo of your handwritten glucose log, and AI extracts all readings automatically
              </p>
              <div className="bg-amber-50 dark:bg-amber-900/20 dark:text-amber-100 p-4 rounded space-y-2 text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#1F3864] dark:text-blue-300 mb-4">Dashboard Overview</h2>

            <div className="space-y-4">
              {/* Stats Cards */}
              <div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Stats Cards (Top Row)</h4>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm">
                  <div className="bg-red-50 dark:bg-red-900/30 p-3 rounded border border-red-200 dark:border-red-900/50">
                    <p className="font-semibold text-red-900 dark:text-red-300">Average Fasting</p>
                    <p className="text-slate-600 dark:text-slate-400 text-xs mt-1">Average of all fasting readings for this month</p>
                  </div>
                  <div className="bg-blue-50 dark:bg-blue-900/30 p-3 rounded border border-blue-200 dark:border-blue-900/50">
                    <p className="font-semibold text-blue-900 dark:text-blue-300">Avg Post-Meal</p>
                    <p className="text-slate-600 dark:text-slate-400 text-xs mt-1">Average of all post-meal readings</p>
                  </div>
                  <div className="bg-slate-50 dark:bg-slate-800 p-3 rounded border border-slate-200 dark:border-slate-700">
                    <p className="font-semibold text-slate-900 dark:text-slate-200">Total Readings</p>
                    <p className="text-slate-600 dark:text-slate-400 text-xs mt-1">Count of all readings in database</p>
                  </div>
                </div>
              </div>
              ...
              {/* Month Selector */}
              <div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Month Selector</h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm">
              ...
              {/* Color Legend */}
              <div>
                <h4 className="font-semibold text-slate-900 dark:text-white mb-2">Color Legend</h4>
          ...
          {/* Units */}
          <section className="bg-slate-50 dark:bg-slate-800 p-4 rounded-xl">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-2">Unit Conversion</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-3">
          ...
          {/* Tips */}
          <section>
            <h2 className="text-xl font-bold text-[#1F3864] dark:text-blue-300 mb-4">Quick Tips</h2>
