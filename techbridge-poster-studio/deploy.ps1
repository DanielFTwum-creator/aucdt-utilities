# techbridge-poster-studio — Deploy Script
# URL: https://ai-tools.techbridge.edu.gh/techbridge-poster-studio/
# Usage: .\deploy.ps1 -Build

param(
    [string]$RemoteHost = "root@techbridge.edu.gh",
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/techbridge-poster-studio/",
    [switch]$Build = $false
)
...
$SUBFOLDER     = "techbridge-poster-studio"
...
Log "INFO" "========================================" Cyan
Log "INFO" "techbridge-poster-studio DEPLOYMENT" Cyan
Log "INFO" "========================================" Cyan
...
if ($Build) {
    ...
    $buildDir = "/tmp/tb-poster-studio_deploy_$commit"
    $serverScript = @"
set -e
...
log '[2/5] Cloning techbridge-poster-studio (sparse, depth 1)...'
git clone --depth 1 --filter=blob:none --sparse '$GITHUB_REPO' $buildDir
cd $buildDir
git sparse-checkout set techbridge-poster-studio
cd techbridge-poster-studio
...
<IfModule mod_rewrite.c>
  RewriteEngine On
  RewriteBase /techbridge-poster-studio/
  RewriteCond %{REQUEST_FILENAME} -f [OR]
  RewriteCond %{REQUEST_FILENAME} -d
  RewriteRule ^ - [L]
  RewriteRule ^ /techbridge-poster-studio/index.html [QSA,L]
</IfModule>
...
Log "SUCCESS" "URL  : https://ai-tools.techbridge.edu.gh/techbridge-poster-studio/" Green
