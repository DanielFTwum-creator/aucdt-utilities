...
**Project:** Infrastructure monitoring and management - App ID 115
**Version:** 3.0.0
**Status:** As-Built
...
This Software Requirements Specification (SRS) documents the requirements for **Infrastructure monitoring and management - App ID 115**, a web application deployed as part of the Techbridge University College (TUC) institutional utility suite. It serves as the authoritative reference for developers, testers, and stakeholders.

### 1.2 Scope

**Infrastructure monitoring and management - App ID 115** is a TypeScript-based React 19 single-page application (SPA) built with Vite and deployed via Docker/Nginx. It operates within the TUC monorepo (`aucdt-utilities`) and conforms to the Techbridge University College Shared Standards.
...
**Infrastructure monitoring and management - App ID 115** is a standalone module within the TUC institutional web application suite. It communicates with TUC backend services via REST APIs and shares the TUC design system (Tailwind CSS, Playfair Display, Bebas Neue, Cormorant Garamond).
