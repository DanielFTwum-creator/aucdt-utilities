# synthetic-user-simulator - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for synthetic-user-simulator.
...
All notable changes to the Synthetic User Simulator (App ID 123) project will be documented in this file.
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Synthetic User Simulator | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Synthetic User Simulator | Techbridge University College" />
    ...
    <title>Synthetic User Simulator | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root" role="main" aria-label="Synthetic User Simulator">
      <div class="tuc-splash">
        <span class="tuc-logo">TECHBRIDGE</span>
        <div class="tuc-status">synthetic user simulator</div>
...
/**
 * E2E stub — synthetic-user-simulator
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('synthetic-user-simulator E2E', () => {
