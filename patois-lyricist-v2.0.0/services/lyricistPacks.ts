...
export const LANGUAGE_PACKS: LanguagePack[] = [
  ...
  { id: 'fr', label: 'French / Français', dictionGuidance: `Write the ENTIRE lyric in French. This is a French-language song, not English sprinkled with a few French words. Every section — verses, pre-chorus, hook, bridge, ad-libs — is in natural, singable French, in the warm West-African register heard in Côte d'Ivoire, Burkina Faso, Togo and Benin (coupé-décalé / nouchi flavour where the genre allows). Use correct accents (é, è, ê, à, ç, ù, î, ô). Only a rare place name or one-word interjection may be English or local; the body stays French from the first line to the last. If a line comes out in English, rewrite it in French before finalising.` },
];
