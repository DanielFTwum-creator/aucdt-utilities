...
export const LANGUAGE_PACKS: LanguagePack[] = [
  ...
  { id: 'tw', label: 'Twi', dictionGuidance: `Write predominantly in Akan (Twi) — the body of the lyric (verses and hook) is in natural, everyday, singable Twi. English is only light seasoning: an occasional line, a key phrase, or an ad-lib for flow and accessibility, never the base language.` },
  { id: 'ga', label: 'Ga', dictionGuidance: `Write predominantly in Ga (Accra) — the body of the lyric is in natural, singable Ga, honouring Ga cadence in the hook. English is only light seasoning (an occasional line or phrase for flow and accessibility), never the base language.` },
  { id: 'ee', label: 'Ewe', dictionGuidance: `Write predominantly in Ewe — the body of the lyric is in natural, singable Ewe, letting Ewe carry the most heartfelt lines. English is only light seasoning (an occasional line or phrase for flow and accessibility), never the base language.` },
  ...
  { id: 'fr', label: 'French / Français', dictionGuidance: `Write predominantly in French — the body of the lyric is in natural, singable French, in the warm West-African register heard in Côte d'Ivoire, Burkina Faso, Togo and Benin (coupé-décalé / nouchi flavour where the genre allows). Use correct accents (é, è, ê, à, ç, ù, î, ô). English is only light seasoning — a hook line, a key phrase, an ad-lib — never the base language; do not default to writing the song in English.` },
];
