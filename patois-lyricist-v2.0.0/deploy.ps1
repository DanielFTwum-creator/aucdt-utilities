...
Log "INFO" "=== PATOIS LYRICIST DEPLOYMENT ===" Cyan
...
Get-ChildItem -Path "dist" | ForEach-Object {
    if (# Patois Lyricist Deployment Script
# SCP-based deployment using bash
...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/lyricist`n"
# Patois Lyricist Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/lyricist`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# Patois Lyricist Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/lyricist`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# Patois Lyricist Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/lyricist`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
