...
param(
    ...
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/patois-lyricist-v2.0.0/",
    [switch]$Build = $false
)
...
<IfModule mod_rewrite.c>
  RewriteEngine On
  RewriteBase /patois-lyricist-v2.0.0/
  RewriteCond %{REQUEST_FILENAME} -f [OR]
  RewriteCond %{REQUEST_FILENAME} -d
  RewriteRule ^ - [L]
  RewriteRule ^ /patois-lyricist-v2.0.0/index.html [QSA,L]
</IfModule>
...
Log "SUCCESS" "URL  : https://ai-tools.techbridge.edu.gh/patois-lyricist-v2.0.0/" Green
