...
Log "INFO" "=== ORBIT WALK REMINDER DEPLOYMENT ===" Cyan
...
Get-ChildItem -Path "dist" | ForEach-Object {
    if (# Orbit Walk Reminder Deployment Script
# SCP-based deployment using bash
...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/orbit-walk-reminder`n"
# Orbit Walk Reminder Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/orbit-walk-reminder`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# Orbit Walk Reminder Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/orbit-walk-reminder`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# Orbit Walk Reminder Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/orbit-walk-reminder`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
