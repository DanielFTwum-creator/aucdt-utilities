(function ($) {
    ...
    04. Sticky fix
    05. Scroll To Top
    06. Set Background Image Colour & Mask
    07. Global Slider
  ...
  /*---------- 01. On Load Function ----------*/
    ...
    function activateGlobalSliderTabs(tabSelector, sliderSelector) {
        ...
        // Initial state
        var initialIndex = (swipers[0] && swipers[0].realIndex) || 0;
    ...
    // Removed anti-inspect and right-click disable to allow full customization and developer tools access.
