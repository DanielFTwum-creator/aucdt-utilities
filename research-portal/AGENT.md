# research-portal - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for research-portal.
...
DATABASE_URL=postgresql://user:password@localhost:5432/research_portal_db
...
```json
{
  ...
  "version": "1.0.0",
  "description": "Backend API for Research Portal",
  "main": "dist/server.js",
  "scripts": {
...
### 1.1 Purpose
This document specifies the functional and non-functional requirements for Research Portal, a comprehensive management system designed to manage and track Research Portal operations.

### 1.2 Scope
Research Portal will provide:
...
Research Portal is a web-based management system that integrates with:
...
const AUTH_KEY = 'tuc_auth_research_portal';
const ACCENT   = '#0891b2';
    ...
    <div style={{minHeight:'100vh',background:'#f8fafc',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Inter,system-ui,sans-serif'}}>
      <div style={{background:'#fff',padding:'36px',borderRadius:'16px',boxShadow:'0 4px 24px rgba(0,0,0,0.10)',width:'100%',maxWidth:'420px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'6px'}}>
          ...
          <h1 style={{fontSize:'20px',fontWeight:'700',color:'#0f172a',margin:0}}>Research Portal</h1>
        </div>
...
app.listen(PORT, () => {
  console.log(`Research Portal API with Health Check running on port ${PORT}`);
