...
Log "INFO" "=== LUXTHUMB DEPLOYMENT ===" Cyan
...
Get-ChildItem -Path "dist" | ForEach-Object {
    if (# LuxThumb Agent Deployment Script
# Simple SCP-based deployment
...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/luxthumb`n"
# LuxThumb Agent Deployment Script
# Simple SCP-based deployment
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/luxthumb`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# LuxThumb Agent Deployment Script
# Simple SCP-based deployment
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/luxthumb`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# LuxThumb Agent Deployment Script
# Simple SCP-based deployment
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/luxthumb`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
