# whatsapp-parody - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for whatsapp-parody.
...
```md
# Admin Guide — whatsapp-parody

**Application:** whatsapp-parody
...
Audit log data is stored in `localStorage` under the key `tuc_whatsapp-parody_audit`.
...
```md
# Deployment Guide — whatsapp-parody
...
```bash
# From monorepo root
docker-compose -f docker-compose-all-apps.yml build whatsapp-parody
```

### Run

```bash
docker-compose -f docker-compose-all-apps.yml up whatsapp-parody
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Whatsapp Parody | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Whatsapp Parody | Techbridge University College" />
    ...
    <title>Whatsapp Parody | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root">
      <div class="tuc-splash">
        ...
        <div class="tuc-status">whatsapp parody</div>
...
:root {
  ...
  --wa-bg-sub: #202c33;
  --wa-bg-chat: #0b141a;
  --wa-bg-bubble-sent: #005c4b;
  --wa-bg-bubble-received: #202c33;
  --wa-text: #e9edef;
...
/* ... and so on, but we'll use framer-motion stagger */
...
/**
 * E2E stub — whatsapp-parody
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('whatsapp-parody E2E', () => {
