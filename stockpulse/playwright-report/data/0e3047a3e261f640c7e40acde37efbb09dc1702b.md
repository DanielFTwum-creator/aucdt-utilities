...
- Name: auth.spec.ts >> Auth – registration >> new user can register and lands on Watchlist with defaults
      ...
      - generic [ref=e90]:
        - generic [ref=e91]:
          ...
          - textbox "Full Name" [ref=e93]:
            ...
            - text: E2E User mo6m4srpusgc
        - generic [ref=e94]:
          - generic [ref=e95]: Email
          - textbox "Email" [ref=e96]:
            - /placeholder: you@example.com
            - text: e2e_mo6m4srpusgc@test.local
        - generic [ref=e97]:
