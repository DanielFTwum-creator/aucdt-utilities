...
- Name: auth.spec.ts >> Auth – login >> wrong password shows error and stays on modal
- Location: e2e\auth.spec.ts:107:3
      ...
      - generic [ref=e87]:
        - generic [ref=e88]:
          ...
          - textbox "Email" [ref=e90]:
            ...
            - text: e2e_badpw_mo6m5q1rwm0s@test.local
        - generic [ref=e91]:
          - generic [ref=e92]: Password
          - generic [ref=e93]:
            - textbox "Password" [active] [ref=e94]:
              - /placeholder: ••••••••
              - text: WrongPassword99!
