...
/**
 * WMS SSO guard for the Brand Guideline Checker API (TUC-ICT-SRS-2026-013).
 ...
 * the intended audience for the checker. To restrict to staff, narrow the
 * ALLOWED_DOMAIN check — a one-line change.
 */
