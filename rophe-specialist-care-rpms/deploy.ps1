...
Get-ChildItem -Path "dist" | ForEach-Object {
    if (# ROPHE Specialist Care RPMs Deployment Script
# SCP-based deployment using bash
...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/care`n"
# ROPHE Specialist Care RPMs Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/care`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# ROPHE Specialist Care RPMs Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/care`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# ROPHE Specialist Care RPMs Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/care`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
