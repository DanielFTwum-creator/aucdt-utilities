# pdf-to-assessment-json-converter - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for pdf-to-assessment-json-converter.
...
const AUTH_KEY = 'tuc_auth_pdf_to_assessment_json_converter';
const ACCENT   = '#4f46e5';
    ...
    <div style={{minHeight:'100vh',background:'#f8fafc',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Inter,system-ui,sans-serif'}}>
      <div style={{background:'#fff',padding:'36px',borderRadius:'16px',boxShadow:'0 4px 24px rgba(0,0,0,0.10)',width:'100%',maxWidth:'420px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'6px'}}>
          ...
          <h1 style={{fontSize:'20px',fontWeight:'700',color:'#0f172a',margin:0}}>Pdf To Assessment Json Converter</h1>
        </div>
...
export const UploadIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM21 21v-5.25" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 15H6.75A2.25 2.25 0 014.5 12.75V9A2.25 2.25 0 016.75 6.75h10.5A2.25 2.25 0 0119.5 9v3.75a2.25 2.25 0 01-2.25 2.25H15" />
  </svg>
);
...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M18.667 15.333A3 3 0 1 0 15 12"/>
    <path d="M18.12 8.88A3 3 0 1 0 12 5"/>
    <path d="M5.333 15.333A3 3 0 1 0 9 12"/>
    ...
    <path d="m14.5 13.5 1 1"/>
    <path d="m9.5 13.5-1 1"/>
    <path d="M7 12h-1"/>
    <path d="M18 12h-1"/>
    <path d="m12 17.5 1.5 1.5"/>
    <path d="m12 17.5-1.5 1.5"/>
...
### FILE: components/JsonDisplay.tsx
```typescript
...
const Loader: React.FC = () => {
  return (
    <div className="absolute inset-0 bg-slate-900/80 backdrop-blur-sm flex flex-col items-center justify-center z-10">
        ...
        <p className="mt-4 text-slate-300 text-lg">Analyzing PDF...</p>
...
This application is deployed behind an Nginx reverse proxy at the path `/pdf-to-assessment-json-converter/`.

## Required Configuration for Docker/Nginx Deployment

### 1. Vite Base Path (vite.config.ts)

The Vite config MUST include `base: '/pdf-to-assessment-json-converter/'` to ensure all assets (JS, CSS) load correctly:

```typescript
export default defineConfig(({mode}) => {
  return {
    base: '/pdf-to-assessment-json-converter/',  // REQUIRED: Assets must load from /pdf-to-assessment-json-converter/assets/
    plugins: [react(), ...],
    // ... rest of config
  };
});
...
If using React Router, the BrowserRouter MUST include `basename="/pdf-to-assessment-json-converter"` for client-side routing:

```typescript
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <BrowserRouter basename="/pdf-to-assessment-json-converter">
      <App />
    </BrowserRouter>
  </StrictMode>,
);
...
- **Nginx Configuration**: The app is served at `http://localhost:8080/pdf-to-assessment-json-converter/`, not at the root
- **Asset Loading**: Without `base: '/pdf-to-assessment-json-converter/'`, assets try to load from `/assets/` instead of `/pdf-to-assessment-json-converter/assets/`
- **Routing**: Without `basename="/pdf-to-assessment-json-converter"`, React Router treats routes incorrectly
...
- Script tags should reference: `/pdf-to-assessment-json-converter/assets/index-*.js`
- Link tags should reference: `/pdf-to-assessment-json-converter/assets/index-*.css`

If they reference `/assets/` instead of `/pdf-to-assessment-json-converter/assets/`, the configuration is incorrect.

## Deployment URLs

- **Development**: `http://localhost:5173` (Vite dev server, no base path needed)
- **Production (Docker)**: `http://localhost:8080/pdf-to-assessment-json-converter/`
- **Production (Staging/Live)**: `https://portal.aucdt.edu.gh/pdf-to-assessment-json-converter/` (or similar)
...
**Project**: pdf-to-assessment-json-converter
...
```md
# Admin Guide — pdf-to-assessment-json-converter

**Application:** pdf-to-assessment-json-converter
...
Audit log data is stored in `localStorage` under the key `tuc_pdf-to-assessment-json-converter_audit`.
...
```md
# Deployment Guide — pdf-to-assessment-json-converter
...
```bash
# From monorepo root
docker-compose -f docker-compose-all-apps.yml build pdf-to-assessment-json-converter
```

### Run

```bash
docker-compose -f docker-compose-all-apps.yml up pdf-to-assessment-json-converter
...
This Software Requirements Specification (SRS) documents the requirements for **Pdf To Assessment Json Converter**, a web application deployed as part of the Techbridge University College (TUC) institutional utility suite. It serves as the authoritative reference for developers, testers, and stakeholders.

### 1.2 Scope

**Pdf To Assessment Json Converter** is a TypeScript-based React 19 single-page application (SPA) built with Vite and deployed via Docker/Nginx. It operates within the TUC monorepo (`aucdt-utilities`) and conforms to the Techbridge University College Shared Standards.
...
**Pdf To Assessment Json Converter** is a standalone module within the TUC institutional web application suite. It communicates with TUC backend services via REST APIs and shares the TUC design system (Tailwind CSS, Playfair Display, Bebas Neue, Cormorant Garamond).
...
```md
# Testing Guide — pdf-to-assessment-json-converter
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Pdf To Assessment Json Converter | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Pdf To Assessment Json Converter | Techbridge University College" />
    ...
    <title>Pdf To Assessment Json Converter | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root">
      <div class="tuc-splash">
        ...
        <div class="tuc-status">pdf to assessment json converter</div>
...
```json
{
  "name": "PDF to Assessment JSON Converter",
  "description": "An AI-powered tool to convert PDF documents containing university program and assessment data into a structured JSON format. Upload a PDF, and the tool will automatically extract and format the information.",
...
### FILE: playgrow-smart-fun-for-bright-minds/.env.local
```text
...
View your app in AI Studio: https://ai.studio/apps/drive/1OaAopbfFJznBrwack14kK1MmflgIt9Nz
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-60 bg-[#0f172a] text-white flex flex-col p-6 shrink-0" aria-label="Admin navigation">
        <div className="flex items-center gap-3 mb-10">
          ...
          <span className="font-bold text-sm">Pdf To Assessment Json Converter</span>
        </div>
      ...
      <main className="flex-1 p-8 max-w-4xl" role="main">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Pdf To Assessment Json Converter — Admin</h1>
...
/**
 * E2E stub — pdf-to-assessment-json-converter
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('pdf-to-assessment-json-converter E2E', () => {
...
export default defineConfig(({ mode }) => {
    ...
    return {
      plugins: [react(), tailwindcss()], // Add React plugin
  base: './',
      define: {
      ...
      esbuild: {
        // Ensure proper handling of JSX/TSX files
        loader: 'tsx',
        include: /\.(tsx?|jsx?)$/,
        exclude: []
      }
...
// Vitest unit test configuration — pdf-to-assessment-json-converter
...
// Vitest E2E configuration — pdf-to-assessment-json-converter
