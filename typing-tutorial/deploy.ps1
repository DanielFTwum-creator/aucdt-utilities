...
# URL: https://ai-tools.techbridge.edu.gh/typing-tutor/
# Usage: .\deploy.ps1 -Build

param(
    [string]$RemoteHost = "root@techbridge.edu.gh",
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/typing-tutor/",
    [switch]$Build = $false
)
...
Log "INFO" "========================================" Cyan
Log "INFO" "typing-tutorial DEPLOYMENT" Cyan
Log "INFO" "========================================" Cyan
...
log '[2/5] Cloning typing-tutorial (sparse, depth 1)...'
...
Log "SUCCESS" "URL  : https://ai-tools.techbridge.edu.gh/typing-tutor/" Green
