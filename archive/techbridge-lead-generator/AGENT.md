# techbridge-lead-generator - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for techbridge-lead-generator.
...
```md
# Admin Guide — tuc-lead-generator

**Application:** tuc-lead-generator
...
Audit log data is stored in `localStorage` under the key `tuc_tuc-lead-generator_audit`.
...
```md
# Deployment Guide — tuc-lead-generator
...
```bash
# From monorepo root
docker-compose -f docker-compose-all-apps.yml build tuc-lead-generator
```

### Run

```bash
docker-compose -f docker-compose-all-apps.yml up tuc-lead-generator
...
This Software Requirements Specification (SRS) documents the requirements for **Tuc Lead Generator**, a web application deployed as part of the Techbridge University College (TUC) institutional utility suite. It serves as the authoritative reference for developers, testers, and stakeholders.

### 1.2 Scope

**Tuc Lead Generator** is a TypeScript-based React 19 single-page application (SPA) built with Vite and deployed via Docker/Nginx. It operates within the TUC monorepo (`aucdt-utilities`) and conforms to the Techbridge University College Shared Standards.
...
**Tuc Lead Generator** is a standalone module within the TUC institutional web application suite. It communicates with TUC backend services via REST APIs and shares the TUC design system (Tailwind CSS, Playfair Display, Bebas Neue, Cormorant Garamond).
...
```md
# Testing Guide — tuc-lead-generator
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Tuc Lead Generator | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Tuc Lead Generator | Techbridge University College" />
    ...
    <title>Tuc Lead Generator | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root">
      <div class="tuc-splash">
        ...
        <div class="tuc-status">tuc lead generator</div>
...
```json
{
  ...
  "name": "techbridge-lead-generator",
  "private": true,
  "version": "0.0.0",
  "type": "module",
  "scripts": {
...
const AUTH_KEY = 'tuc_auth_techbridge_lead_generator';
const ACCENT   = '#d97706';
    ...
    <div style={{minHeight:'100vh',background:'#f8fafc',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Inter,system-ui,sans-serif'}}>
      <div style={{background:'#fff',padding:'36px',borderRadius:'16px',boxShadow:'0 4px 24px rgba(0,0,0,0.10)',width:'100%',maxWidth:'420px'}}>
        <div style={{display:'flex',alignItems:'center',gap:'12px',marginBottom:'6px'}}>
          ...
          <h1 style={{fontSize:'20px',fontWeight:'700',color:'#0f172a',margin:0}}>Techbridge Lead Generator</h1>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-60 bg-[#0f172a] text-white flex flex-col p-6 shrink-0" aria-label="Admin navigation">
        <div className="flex items-center gap-3 mb-10">
          ...
          <span className="font-bold text-sm">Tuc Lead Generator</span>
        </div>
      ...
      <main className="flex-1 p-8 max-w-4xl" role="main">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">Tuc Lead Generator — Admin</h1>
...
/**
 * E2E stub — tuc-lead-generator
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('tuc-lead-generator E2E', () => {
...
// Vitest unit test configuration — tuc-lead-generator
...
// Vitest E2E configuration — tuc-lead-generator
