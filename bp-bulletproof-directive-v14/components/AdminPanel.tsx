...
export const AdminPanel: React.FC<AdminPanelProps> = ({ currentRoute, auditLogs, onNavigate, onReturnToApp }) => {
        ...
        <div className="flex h-screen overflow-hidden">
            ...
            <main className="flex-1 flex flex-col bg-bg-primary overflow-hidden">
                ...
                <header className="md:hidden h-16 border-b border-border bg-bg-secondary flex items-center justify-between px-4">
                    ...
                    <button onClick={onReturnToApp}><Icons.X className="w-6 h-6 text-text-muted" /></button>
                </header>
                        ...
                        <div className="animate-fade-in max-w-5xl mx-auto">
                            ...
                            <div className="grid md:grid-cols-3 gap-6 mb-8">
                                ...
                                <div className="p-6 rounded-xl bg-bg-secondary border border-border">
                                    ...
                                    <div className="text-2xl font-bold text-text-primary">v19.2.4</div>
                                </div>
                            </div>
