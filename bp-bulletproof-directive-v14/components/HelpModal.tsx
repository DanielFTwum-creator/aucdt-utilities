                ...
                <div className="p-6 overflow-y-auto max-h-[60vh] space-y-8">
                    <section>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="p-4 rounded-lg bg-bg-tertiary border border-border">
                                <h4 className="font-bold text-text-primary">How does the AI assistant work?</h4>
                                <p className="text-sm text-text-secondary">Click "Refine with AI" on any phase directive to get personalized guidance.</p>
                            </div>
                        </div>
                    </section>
                    <section>
