...
export const PatentApplication: React.FC = () => {
    ...
    const exportToPDF = () => {
        ...
        const sections = [
            ...
            { title: '§ 10. INVENTOR DECLARATION', content: 'I, Daniel Frempong Twum, hereby declare that I am the original inventor of the "Bulletproof Directive" framework. I have reviewed the foregoing application and believe it to be true and complete to the best of my knowledge. [DATE], [APPLICATION_NO]. TUC-ICT-2026.' }
        ];
    ...
    return (
        <div className="space-y-6 animate-fade-in" ref={patentRef}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div className="lg:col-span-3 space-y-6">
                    ...
                    <PatentSection title="§ 10. INVENTOR DECLARATION">
                        <p>I, Daniel Frempong Twum, hereby declare that I am the original inventor of the "Bulletproof Directive" framework. I have reviewed the foregoing application and believe it to be true and complete to the best of my knowledge. [DATE], [APPLICATION_NO]. TUC-ICT-2026.</p>
                    </PatentSection>
                </div>
            ...
            <div className="text-center text-xs text-text-muted mt-12 border-t border-border pt-6">
                Patent Pending · Application No. [AUTO] · TUC-ICT-2026 · 35 U.S.C. §101–103
            </div>
        </div>
    );
};
