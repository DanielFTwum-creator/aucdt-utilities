                ...
                <div>
                    <div key={mode} className="animate-fade-in">
                        ...
                        <button
                          ...
                          disabled={isLoading}
                          className="w-full bg-white border-2 border-default text-primary font-bold py-3.5 px-4 rounded-lg hover:bg-secondary/50 transition flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed mb-6"
                        >
