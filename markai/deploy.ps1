...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/markai`n"
# MarkAI Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/markai`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# MarkAI Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/markai`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# MarkAI Deployment Script
# SCP-based deployment using bash
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/markai`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
