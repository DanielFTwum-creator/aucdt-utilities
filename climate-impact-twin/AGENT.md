# climate-impact-twin - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for climate-impact-twin.
...
All notable changes to the Climate Impact Twin (App ID 190) project will be documented in this file.
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Climate Impact Twin | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Climate Impact Twin | Techbridge University College" />
    ...
    <title>Climate Impact Twin | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root" role="main" aria-label="Climate Impact Twin">
      <div class="tuc-splash">
        <span class="tuc-logo">TECHBRIDGE</span>
        <div class="tuc-status">climate impact twin</div>
...
/**
 * E2E stub — climate-impact-twin
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('climate-impact-twin E2E', () => {
