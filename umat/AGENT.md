# umat - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for umat.
...
param(
    ...
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/umat/",
    [switch]$Build = $false
)
...
bash -c "cd 'C:\Development\github\aucdt-utilities\umat' && scp -r -o StrictHostKeyChecking=no dist/* $RemoteHost`:$RemotePath 2>/dev/null"
...
Write-Host "URL: https://ai-tools.techbridge.edu.gh/umat`n"
...
<html lang="en-GB">
  <head>
    ...
    <meta name="description" content="UMaT Curriculum Recommendations Tracker - Techbridge University College" />
    <meta name="author" content="Techbridge University College" />
    <title>UMaT Tracker · Techbridge University College</title>
    <style>
      * { margin: 0; padding: 0; box-sizing: border-box; }
      body { font-family: 'IBM Plex Sans', system-ui, -apple-system, sans-serif; background: #f8f7f4; color: #1a1a1a; }
    </style>
  </head>
  <body>
    <div id="root"></div>
...
```json
{
  "name": "umat-tracker",
  "version": "1.0.0",
  "description": "UMaT Curriculum Recommendations Tracker",
  "type": "module",
  "scripts": {
    "build": "vite build",
