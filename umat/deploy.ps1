...
Log "INFO" "=== UMAT TRACKER DEPLOYMENT ===" Cyan
...
Get-ChildItem -Path "dist" | ForEach-Object {
    if (# UMaT Tracker Deployment Script
# Simple SCP-based deployment
...
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/umat`n"
# UMaT Tracker Deployment Script
# Simple SCP-based deployment
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/umat`n".PSIsContainer) { scp -r -o StrictHostKeyChecking=no "$(# UMaT Tracker Deployment Script
# Simple SCP-based deployment
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/umat`n".FullName)" "${RemoteHost}:${RemotePath}" }
    else { scp -o StrictHostKeyChecking=no "$(# UMaT Tracker Deployment Script
# Simple SCP-based deployment
...
Log "SUCCESS" "✅ Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/umat`n"_deployStart = Get-Date
function Log {
    param([string]$Level = "INFO", [string]$Msg, [ConsoleColor]$Color = "White")
    $ts = (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
    Write-Host "[$ts][$Level] $Msg" -ForegroundColor $Color
