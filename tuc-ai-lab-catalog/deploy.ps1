...
$tarball = "ai-lab-deploy-$timestamp.tar.gz"
...
Copy-Item -Path ".env.example" -Destination "$staging\.env.example" -Force -ErrorAction SilentlyContinue
...
# Create public/privacy.html if it exists
...
ssh -o StrictHostKeyChecking=no $RemoteHost "rm -rf $RemotePath/* $RemotePath/.htaccess"
...
Write-Host "  curl -I https://ai-tools.techbridge.edu.gh/ai-lab"
Write-Host ""

Write-Host "Next steps:" -ForegroundColor Cyan
Write-Host "  1. Verify at https://ai-tools.techbridge.edu.gh/ai-lab"
...
Write-Host "  4. Clear browser cache if needed (Ctrl+Shift+Delete)"
Write-Host ""
