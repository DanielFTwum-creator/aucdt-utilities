# techbridge-university-college-banner — Deploy Script
# URL: https://ai-tools.techbridge.edu.gh/techbridge-university-college-banner/
# Usage: .\deploy.ps1 -Build

param(
    [string]$RemoteHost = "root@techbridge.edu.gh",
    [string]$RemotePath = "/var/www/vhosts/techbridge.edu.gh/ai-tools.techbridge.edu.gh/techbridge-university-college-banner/",
    [switch]$Build = $false
)
...
$SUBFOLDER     = "techbridge-university-college-banner"
...
Log "INFO" "========================================" Cyan
Log "INFO" "techbridge-university-college-banner DEPLOYMENT" Cyan
Log "INFO" "========================================" Cyan
...
if ($Build) {
    ...
    $buildDir = "/tmp/tb-banner_deploy_$commit"
    $serverScript = @"
set -e
...
log '[2/5] Cloning techbridge-university-college-banner (sparse, depth 1)...'
git clone --depth 1 --filter=blob:none --sparse '$GITHUB_REPO' $buildDir
cd $buildDir
git sparse-checkout set techbridge-university-college-banner
cd techbridge-university-college-banner
...
<IfModule mod_rewrite.c>
  RewriteEngine On
  RewriteBase /techbridge-university-college-banner/
  RewriteCond %{REQUEST_FILENAME} -f [OR]
  RewriteCond %{REQUEST_FILENAME} -d
  RewriteRule ^ - [L]
  RewriteRule ^ /techbridge-university-college-banner/index.html [QSA,L]
</IfModule>
...
Log "SUCCESS" "URL  : https://ai-tools.techbridge.edu.gh/techbridge-university-college-banner/" Green
