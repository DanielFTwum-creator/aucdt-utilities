# knowledge-graph-builder - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for knowledge-graph-builder.
...
All notable changes to the Knowledge Graph Builder (App ID 177) project will be documented in this file.
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Knowledge Graph Builder | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Knowledge Graph Builder | Techbridge University College" />
    ...
    <title>Knowledge Graph Builder | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root" role="main" aria-label="Knowledge Graph Builder">
      <div class="tuc-splash">
        <span class="tuc-logo">TECHBRIDGE</span>
        <div class="tuc-status">knowledge graph builder</div>
...
/**
 * E2E stub — knowledge-graph-builder
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('knowledge-graph-builder E2E', () => {
