...
public class SecurityUtils {
    ...
    public static void userIdControl(Long headerUserId, Long userId) {
        log.info("User information headerUserId :" + headerUserId + "userId :" + userId);
        if (!userId.equals(headerUserId)) {
            log.info(" the user match is true :" + userId);
            throw new BusinessException(HttpStatus.UNAUTHORIZED, ResponseMessageEnum.BACK_SECURITY_MSG_001.messageDetail());
        }
    }
    ...
    public static String encrypt(String text) {
        ...
        try {
            ...
            throw new BusinessException(HttpStatus.BAD_REQUEST, ResponseMessageEnum.BACK_SECURITY_MSG_002.messageDetail());
        }
        return ecryptedText;
    }
