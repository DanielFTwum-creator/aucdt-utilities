...
Log "SUCCESS" "OK Deployment complete!" Green
Log "INFO" "URL: https://ai-tools.techbridge.edu.gh/dictation`n"
Log "INFO" "Cleaning up node_modules and dist directories to free up space..." Cyan
