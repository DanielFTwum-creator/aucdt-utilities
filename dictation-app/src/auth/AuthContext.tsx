    ...
    const restoreSession = async () => {
      ...
      if (cookieValue) {
        try {
          ...
          setUser(userData);
          setIsAuthenticated(true);
          // Clear the cookie after reading using bulletproof deletion
          const pastDate = 'Thu, 01 Jan 1970 00:00:00 GMT';
          document.cookie = `ai_lab_user=; expires=${pastDate}; path=/ai-lab/; secure; samesite=lax`;
          document.cookie = `ai_lab_user=; expires=${pastDate}; path=/; secure; samesite=lax`;
          return;
        } catch (e) {
