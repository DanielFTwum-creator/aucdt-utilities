# cross-app-performance-synthesizer - Ultimate Self-Replicating Blueprint (AGENT.md)

> [!IMPORTANT]
> This is an auto-generated monolithic blueprint containing the source code for cross-app-performance-synthesizer.
...
All notable changes to the Cross-App Performance Synthesizer (App ID 245) project will be documented in this file.
...
<html lang="en-GB">
  <head>
    ...
    <meta property="og:title" content="Cross App Performance Synthesizer | Techbridge University College" />
    ...
    <meta name="twitter:title" content="Cross App Performance Synthesizer | Techbridge University College" />
    ...
    <title>Cross App Performance Synthesizer | Techbridge University College</title>
  ...
  <body>
    ...
    <div id="root" role="main" aria-label="Cross App Performance Synthesizer">
      <div class="tuc-splash">
        <span class="tuc-logo">TECHBRIDGE</span>
        <div class="tuc-status">cross app performance synthesizer</div>
...
```json
{
  "name": "cross-app-performance-synthesizer",
  "version": "2.0.0",
  "private": true,
...
/**
 * E2E stub — cross-app-performance-synthesizer
 * Extend with Puppeteer/Playwright tests.
 * Run: node scripts/phase3-test-scaffold.js --apply then pnpm test:e2e
 */
describe('cross-app-performance-synthesizer E2E', () => {
