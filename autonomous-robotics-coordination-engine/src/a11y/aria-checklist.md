# ARIA Accessibility Checklist — Autonomous Robotics Coordination Engine
...
### Landmark Regions
- [ ] Wrap app content in `<AccessibleLayout label="Autonomous Robotics Coordination Engine">`
